...
pkgdatadir = $(datadir)/bar
pkgincludedir = $(includedir)/bar
pkglibdir = $(libdir)/bar
pkglibexecdir = $(libexecdir)/bar
...
bin_PROGRAMS = bar$(EXEEXT)
noinst_PROGRAMS = test-types$(EXEEXT) test-001-pre$(EXEEXT) \
	test-001-post$(EXEEXT)
TESTS = test-types$(EXEEXT) test-001 test-002
subdir = .
...
am_bar_OBJECTS = error.$(OBJEXT) fd.$(OBJEXT) io.$(OBJEXT) \
	display.$(OBJEXT) args.$(OBJEXT) bar.$(OBJEXT)
bar_OBJECTS = $(am_bar_OBJECTS)
bar_LDADD = $(LDADD)
am_test_001_post_OBJECTS = test-001-post.$(OBJEXT)
test_001_post_OBJECTS = $(am_test_001_post_OBJECTS)
test_001_post_LDADD = $(LDADD)
am_test_001_pre_OBJECTS = test-001-pre.$(OBJEXT)
test_001_pre_OBJECTS = $(am_test_001_pre_OBJECTS)
test_001_pre_LDADD = $(LDADD)
am_test_types_OBJECTS = test-types.$(OBJEXT)
...
am__depfiles_remade = ./$(DEPDIR)/args.Po ./$(DEPDIR)/bar.Po \
	./$(DEPDIR)/display.Po ./$(DEPDIR)/error.Po ./$(DEPDIR)/fd.Po \
	./$(DEPDIR)/io.Po ./$(DEPDIR)/test-001-post.Po \
	./$(DEPDIR)/test-001-pre.Po ./$(DEPDIR)/test-types.Po
am__mv = mv -f
...
am__v_CCLD_1 = 
SOURCES = $(bar_SOURCES) $(test_001_post_SOURCES) \
	$(test_001_pre_SOURCES) $(test_types_SOURCES)
DIST_SOURCES = $(bar_SOURCES) $(test_001_post_SOURCES) \
	$(test_001_pre_SOURCES) $(test_types_SOURCES)
...
TEST_LOG_COMPILE = $(TEST_LOG_COMPILER) $(AM_TEST_LOG_FLAGS) \
	$(TEST_LOG_FLAGS)
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/bar.1.in \
	$(srcdir)/config.h.in $(srcdir)/doxygen.conf.in \
	$(srcdir)/sourceforge.mk AUTHORS COPYING ChangeLog INSTALL \
	NEWS README TODO compile config.guess config.sub depcomp \
	install-sh ltmain.sh missing mkinstalldirs test-driver
...
ACLOCAL = ${SHELL} '/data/data/com.termux/files/home/src/bar-1.11.1/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_CFLAGS =  -m64
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/data/data/com.termux/files/home/src/bar-1.11.1/missing' autoconf
AUTOHEADER = ${SHELL} '/data/data/com.termux/files/home/src/bar-1.11.1/missing' autoheader
AUTOMAKE = ${SHELL} '/data/data/com.termux/files/home/src/bar-1.11.1/missing' automake-1.16
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/data/data/com.termux/files/home/src/bar-1.11.1/missing' makeinfo
MAX_SAFE_MULTIPLIER = 
...
STRIP = 
VERSION = 1.11.1
abs_builddir = /data/data/com.termux/files/home/src/bar-1.11.1
abs_srcdir = /data/data/com.termux/files/home/src/bar-1.11.1
abs_top_builddir = /data/data/com.termux/files/home/src/bar-1.11.1
abs_top_srcdir = /data/data/com.termux/files/home/src/bar-1.11.1
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /data/data/com.termux/files/home/src/bar-1.11.1/install-sh
...
CLEANFILES = *~ test-file-002.1.bin test-file-002.2.bin \
	test-file-003.incomplete.bin test-file-003.1.bin \
	test-file-003.2.bin test-pipe-003.1 test-pipe-003.2 \
	test-pipe-003.3 test-file-004.incomplete.bin test-file-004.bin \
	test-file-004.1.bin test-file-004.2.bin
...
# EXTRA_DIST += PORTING
EXTRA_DIST = test-001 test-002 test-003 test-004 itest itest2 \
	$(man_MANS) autogen debian/changelog debian/control \
	debian/copyright debian/dirs debian/install debian/rules \
	sourceforge.mk TROUBLESHOOTING troubleshooter infofile
man_MANS = bar.1
test_types_SOURCES = \
	test-types.c \
	#
...
SOURCEFORGE_COMPILE_FARM_HOSTS = x86-linux2 x86-openbsd1 x86-solaris1 \
	x86-linux1 x86-freebsd1 x86-netbsd1 amd64-linux1 amd64-linux2 \
	alpha-linux1 ppc-osx1 ppc-osx2 sparc-solaris1 openpower-linux1
...
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(srcdir)/sourceforge.mk $(am__configure_deps)
	@for dep in $?; do \
...
$(srcdir)/sourceforge.mk $(am__empty):
...
bar.1: $(top_builddir)/config.status $(srcdir)/bar.1.in
...
bar$(EXEEXT): $(bar_OBJECTS) $(bar_DEPENDENCIES) $(EXTRA_bar_DEPENDENCIES) 
	@rm -f bar$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(bar_OBJECTS) $(bar_LDADD) $(LIBS)

test-001-post$(EXEEXT): $(test_001_post_OBJECTS) $(test_001_post_DEPENDENCIES) $(EXTRA_test_001_post_DEPENDENCIES) 
	@rm -f test-001-post$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(test_001_post_OBJECTS) $(test_001_post_LDADD) $(LIBS)

test-001-pre$(EXEEXT): $(test_001_pre_OBJECTS) $(test_001_pre_DEPENDENCIES) $(EXTRA_test_001_pre_DEPENDENCIES) 
	@rm -f test-001-pre$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(test_001_pre_OBJECTS) $(test_001_pre_LDADD) $(LIBS)
...
include ./$(DEPDIR)/bar.Po # am--include-marker
include ./$(DEPDIR)/display.Po # am--include-marker
include ./$(DEPDIR)/error.Po # am--include-marker
include ./$(DEPDIR)/fd.Po # am--include-marker
include ./$(DEPDIR)/io.Po # am--include-marker
include ./$(DEPDIR)/test-001-post.Po # am--include-marker
include ./$(DEPDIR)/test-001-pre.Po # am--include-marker
include ./$(DEPDIR)/test-types.Po # am--include-marker
...
recheck: all 
	...
	$(MAKE) $(AM_MAKEFLAGS) $(TEST_SUITE_LOG) \
	        ...
	        TEST_LOGS="$$log_list"; \
	exit $$?
test-types.log: test-types$(EXEEXT)
	@p='test-types$(EXEEXT)'; \
	b='test-types'; \
...
distclean: distclean-am
	...
	-rm -f ./$(DEPDIR)/fd.Po
	-rm -f ./$(DEPDIR)/io.Po
	-rm -f ./$(DEPDIR)/test-001-post.Po
	-rm -f ./$(DEPDIR)/test-001-pre.Po
	-rm -f ./$(DEPDIR)/test-types.Po
	-rm -f Makefile
